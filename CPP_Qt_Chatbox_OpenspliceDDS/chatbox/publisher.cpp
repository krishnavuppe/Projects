...
void CB_Publisher::publishmsg()
{
    ...
    if(disp == 1)
    {
        ...
        mdisp->append("you: " + mtype->text() + " " + QTime::currentTime().toString());
        mdisp->setAlignment(Qt::AlignRight);
    }
    if(disp == 2)
    {
        msg->uname = "Chaitu";
        ...
        mdisp2->append("you: " + mtype->text() + " " + QTime::currentTime().toString());
        mdisp2->setAlignment(Qt::AlignRight);
    }
    if(disp == 3)
    {
        msg->uname = "Alekya";
        ...
        mdisp3->append("you: " + mtype->text() + " " + QTime::currentTime().toString());
        mdisp3->setAlignment(Qt::AlignRight);
    }
    if(disp == 4)
    {
        msg->uname = "Ravi";
        ...
        mdisp4->append("you: " + mtype->text() + " " + QTime::currentTime().toString());
        mdisp4->setAlignment(Qt::AlignRight);
    }
