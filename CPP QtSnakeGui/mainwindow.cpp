      ...
      game(new GameController(*scene, this))
{
    ...
    setWindowIcon(QIcon(":/images/qtsnake.ico"));
...
{
    scene->setSceneRect(-110, -110, 210, 210);
}
...
{
    QMessageBox::about(this, tr("About this Game"), tr("<h2>Snake Game -> qt gui</h2>"
        "<p>This game is a small Qt application developed by Krishna Vuppe."));
}

void MainWindow::gameHelp()
{
    QMessageBox::about(this, tr("Game Help"), tr("Direction keys -> control the snake to eat the food"
